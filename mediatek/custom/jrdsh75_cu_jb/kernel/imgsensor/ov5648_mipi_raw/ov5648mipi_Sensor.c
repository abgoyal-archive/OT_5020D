...
static void OV5648MIPI_Sensor_Init(void)
{
    ...
    */
	...
	OV5648MIPI_write_cmos_sensor(0x4050, 0x6e); // blc normal freeze 0x37
	...
	//OV5648MIPI_write_cmos_sensor(0x4800, 0x14); //send short packet added by tyrael 
...
UINT32 OV5648MIPIOpen(void)
{
    ...
    //OV5648MIPI_sensor.eng.reg = CAMERA_SENSOR_REG_DEFAULT_VALUE;
    //OV5648MIPI_sensor.eng.cct = CAMERA_SENSOR_CCT_DEFAULT_VALUE;
    //OV5648MIPI_sensor.eng_info.SensorId = 128;
    //OV5648MIPI_sensor.eng_info.SensorType = CMOS_SENSOR;
    //OV5648MIPI_sensor.eng_info.SensorOutputDataFormat = OV5648MIPI_COLOR_FORMAT;

...
//                                THA TH1 THB              THC TH2  THD
	...
	LOGD("[lianhua][CCT_old]eIDX_CCM_CCT_TL84=%d",eIdx_CCM_CCT_old);	
		if	( i4CCT < THA )
		{
	...
	LOGD("[lianhua][CCT_new]eIDX_CCM_CCT_TL84=%d",eIdx_CCM_CCT_new);	

		break;
	case eIDX_CCM_CCT_CWF:
		LOGD("[lianhua][CCT_old]eIDX_CCM_CCT_CWF=%d",eIdx_CCM_CCT_old);		
		if	( i4CCT < THA )
		{
			eIdx_CCM_CCT_new = eIDX_CCM_CCT_TL84;
		}
		...
		LOGD("[lianhua][CCT_new]eIDX_CCM_CCT_CWF=%d",eIdx_CCM_CCT_new);	
		break;
	case eIDX_CCM_CCT_D65:
		LOGD("[lianhua][CCT_old]eIDX_CCM_CCT_D65=%d",eIdx_CCM_CCT_old);	
		if	( i4CCT > THC )
		{
			eIdx_CCM_CCT_new = eIDX_CCM_CCT_D65;
		} 
		...
		LOGD("[lianhua][CCT_new]eIDX_CCM_CCT_D65=%d",eIdx_CCM_CCT_new);	
		break;
	}
#else
    switch  (eIdx_CCM_CCT_old)

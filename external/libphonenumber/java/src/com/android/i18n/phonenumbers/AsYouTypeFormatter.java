...
/* date    | author       | PR #                                 |                                          */
/*=========|==============|======================================|==========================================*/
/*02/07/13 | Xiaodan Fan  |PR405655-Xiaodan-Fan-001              |Contacts force close when connect to wifi */
/*==========================================================================================================*/
...
public class AsYouTypeFormatter {
  ...
  private boolean ableToExtractLongerNdd() {
    if (nationalPrefixExtracted.length() > 0) {
      ...
      //PR405655-Xiaodan-Fan-001 when indexOfPreviousNdd=-1,set prefixBeforeNationalNumber length to 0.
      prefixBeforeNationalNumber.setLength(indexOfPreviousNdd == -1 ? 0 : indexOfPreviousNdd);
    }

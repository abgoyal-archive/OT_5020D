...
static struct alsps_hw cust_alsps_hw = {
	...
	/* modify by tao.zhang.  2012-12-18.   for improve the sensitvity of psensor. start*/
    .ps_threshold_high = 700,
    .ps_threshold_low = 600,
	/* modify by tao.zhang.  2012-12-18.   for improve the sensitvity of psensor. end*/
...
int TMD2771_CMM_PPCOUNT_VALUE = 0x07;  /* modify by tao.zhang.  2013-01-11.   for 0.7cm rubber*/

int ZOOM_TIME = 4;
int TMD2771_CMM_CONTROL_VALUE = (0x20 | 0x40);  /* modify by tao.zhang.  2013-01-11.   for 0.7cm rubber*/

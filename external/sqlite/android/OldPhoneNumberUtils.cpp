...
//CR329138-zhili-wan-001 begin
/*
#ifdef MTK_CTA_SUPPORT 
static int MIN_MATCH = 11;
#else
///M: @}
...
//CR329138-zhili-wan-001 begin
static int getMinMatch(void) {
    char prop_value[PROPERTY_VALUE_MAX] = {'\0'};
    //PR367128-yuguo-yu-001 begin
    //change ro.config.phnum_significant_len to ro_config_phnum_significant_len
    int len = property_get("ro_config_phnum_significant_len", prop_value, "7");
    //PR367128-yuguo-yu-001 end
    prop_value[3] = '\0';
...
bool phone_number_compare_loose(const char* a, const char* b)
{
    ...
    MIN_MATCH = getMinMatch();//CR329138-zhili-wan-001

...
void SkRGB16_Blitter::blitH(int x, int y, int width) {
    ...
    asm volatile (
            ...
            :"memory", "r4", "r8", "r9", "r10", "d0", "d1", "d2", "d3", "d4", "d5", "d6", "d7", "d8", "d9", "d10", "d11", "d12", "d13"
            );
#else
    asm volatile(
            "pld        [%[device]]                         \n\t"
...
void SkRGB16_Blitter::blitRect(int x, int y, int width, int height) {
    ...
    unsigned scale = SkAlpha255To256(0xFF - SkGetPackedA32(src32)) >> 3;
        ...
        asm volatile(
            ...
            :"memory", "r4", "r7", "r8", "r9", "r10", "d0", "d1", "d2", "d3", "d4", "d5", "d6", "d7", "d8", "d9", "d10", "d11", "d12", "d13"
            );

...
#define ENABLE_AUDIO_COMPENSATION_FILTER  //legen open it for loudspeaker

#define ENABLE_AUDIO_DRC_SPEAKER    //legen open it for loudspeaker


#define ENABLE_HEADPHONE_COMPENSATION_FILTER  //legen open for loud-voice

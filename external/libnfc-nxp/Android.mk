...
#
# libpn544_fw.so: Copy pn544 firmware library to system/lib
#
PRODUCT_COPY_FILES += $(LOCAL_PATH)/firmware/pn544/libpn544_fw.so:system/vendor/firmware/libpn544_fw.so
...
#phNfc test
LOCAL_SRC_FILES += src/phNfc_test.c
...
LOCAL_CFLAGS += -DNXP_MESSAGING -DNFC_CUSTOM_CONFIG_INCLUDE -DANDROID -DNFC_TIMER_CONTEXT -DNXP_FW_PARAM -DNXP_FW_DNLD_DIAGNOSTICS -fno-strict-aliasing

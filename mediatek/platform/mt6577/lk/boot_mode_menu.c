...
extern void display_black_picture(void); //tao.zhang@tcl.com 2013-02-06 add for remove the shink when <3.4v to power on.
extern void mt65xx_backlight_on(void);  //tao.zhang@tcl.com 2013-02-06 add for remove the shink when <3.4v to power on.
...
void boot_mode_menu_select()
{
	  ...
	  display_black_picture();  //tao.zhang@tcl.com 2013-02-06 add for remove the shink when <3.4v to power on.
	  mt65xx_backlight_on();    //tao.zhang@tcl.com 2013-02-06 add for remove the shink when <3.4v to power on.

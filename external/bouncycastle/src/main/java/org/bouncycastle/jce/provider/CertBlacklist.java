...
public class CertBlacklist {
    ...
    private static String readBlacklist(String path) {
		...
		//ID: ANDROID-7943607: [Critical] TURKTRUST intermediate certificate revocation
		//(Affected versions: Android 4.2 and earlier, and fixes are provided for GB, ICS and JB)
		//REQ: http://bugzilla.tcl-ta.com/show_bug.cgi?id=406179

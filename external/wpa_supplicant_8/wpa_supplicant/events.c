	...
	for (ssid = group; ssid; ssid = ssid->pnext) {
		...
		if (ssid->disabled) {
			...
			continue;
                ...
                //PR354520-fang.song-001 Modified begin
		...
		//PR354520-fang.song-001 Modified end
...
//merge by liliang.bao  from PR382764 for bug400506 20130129 start
//http://bugzilla.tcl-ta.com/show_bug.cgi?id=400506
//#ifdef CONFIG_ORANGE_SUPPORT
//merge by liliang.bao  from PR382764 for bug400506 20130129 end
static struct wpa_bss *
...
//merge by liliang.bao  from patch DIABLO-GLOBAL-V1.0-DINT-WPA_SUPPLICANT_8-P1.0-4 start
//#endif
//merge by liliang.bao 20130129 end
static struct wpa_bss *
			    ...
			    struct wpa_ssid **selected_ssid)
{
	...
	while (selected == NULL) {
         //merge by liliang.bao  from patch DIABLO-GLOBAL-V1.0-DINT-WPA_SUPPLICANT_8-P1.0-4 start
         //#ifdef CONFIG_ORANGE_SUPPORT
         //PR382764 fang.song-001 modified begin
          ...
          //PR382764 fang.song-001 modified end
          //merge by liliang.bao  20130129 end

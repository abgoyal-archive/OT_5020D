            ...
            case SWCTRL_RX_MDNS_FILTER:
                {
                    ...
                    if (ucOpt0 == SWCR_RX_MDNS_FILTER_CMD_STOP) {
                        ...
                        u4rxfilter = prAdapter->u4OsPacketFilter;
                           /*
                        [SW.Diablo_Orange][DLNA][Multicast]Failed to receive message send by multicast
                        patch_name:JRD390926(For_JRDSH75_CU_JB_ALPS.JB.MP.V1_P167)
                        merge by yang.wu@tcl.com at 2013-2-25 begin
                           */						
                       ...
                       [SW.Diablo_Orange][DLNA][Multicast]Failed to receive message send by multicast
                       patch_name:JRD390926(For_JRDSH75_CU_JB_ALPS.JB.MP.V1_P167)
                       merge by yang.wu@tcl.com at 2013-2-25 end
                           */
                        fgUpdate = TRUE;
                    }

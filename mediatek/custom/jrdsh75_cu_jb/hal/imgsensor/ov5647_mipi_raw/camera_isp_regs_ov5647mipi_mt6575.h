...
Saturation:{
    ...
    {set:{//00 (middle saturation)
        ...
        0x00010709, 0x3040E0F0, 0x264C5650, 0x30000000, 0xFF00FF00, 0x001A2D40, 0x000A0A0A, 0x00643C1E,
    ...
    {set:{//02 (middle saturation)
        ...
        0x00010709, 0x3040E0F0, 0x2046524E, 0x30000000, 0xFF00FF00, 0x001A2D40, 0x000A0A0A, 0x00643C1E,

    }},

    {set:{//03 (middle saturation)

        0x00010709, 0x3040E0F0, 0x20404844, 0x30000000, 0xFF00FF00, 0x001A2D40, 0x000A0A0A, 0x00643C1E,

    }},

    {set:{//04 (middle saturation)

        0x00010709, 0x3040E0F0, 0x20384038, 0x30000000, 0xFF00FF00, 0x001A2D40, 0x000A0A0A, 0x00643C1E,
...
CCM:{
    {set:{//00
        0x01930477, 0x041C043B, 0x011C001F, 0x00180517, 0x01FF0000, 
    }},
    {set:{//01
        0x01EF04E1, 0x040E0432, 0x01110021, 0x001F04BB, 0x019C0000, 
    }},
    {set:{//02
        0x01B5048F, 0x04260421, 0x01310410, 0x0020048A, 0x016A0000, 
    }}
},
Gamma:{
    {set:{//00

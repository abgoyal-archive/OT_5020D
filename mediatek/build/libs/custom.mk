...
$(JRD_PROJECT_FOLDER) $(_fp_list_) $(_cust_list_) $(call lc,$(MTK_PLATFORM)) common)
endef
...
#hongmei.zhu add for custom projectconfig.mk
JRD_PROJECT_FOLDER := ../../$(call wildcard2,*_wimdata_ng)/wconfig/version

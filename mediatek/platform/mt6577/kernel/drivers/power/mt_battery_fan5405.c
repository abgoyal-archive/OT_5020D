 ...
 * James Lo
 *
 //hongmei temp use this file in camryJB,driver team need check 
 ****************************************************************************/
...
int charing_full_once = 0;	//mingquan.lai modify 20130125 for Camry
...
#else 
#define TOPOFF_CHG_VOLTAGE      4050
#endif
...
void check_fan5405_fault_status(uint8_t fault_bit, uint8_t work_mode){
        ...
        case BOOST_NORMAL_STATUS:
			...
			#else
			fan_struct->ops->set_con2_val(fan_struct, 0x23, 0x01, 0x01); 
			#endif
                /*
...
int BAT_CheckPMUStatusReg(void)
{
    ...
    {   
        charing_full_once = 0 ;		//mingquan.lai modify 20130125 for Camry
...
#endif
int g_FG_init = 0;	//mingquan.lai modify 20130125 for Camry
...
void pchr_turn_on_charging_fan5405(void)
{
    ...
    else
    {
		...
		#else
		fan_struct->ops->set_con2_val(fan_struct, 0x23, 0x01, 0x00);
		#endif
                }
        #endif
...
//int boot_check_once=1;	//mingquan.lai modify 20130125 for Camry

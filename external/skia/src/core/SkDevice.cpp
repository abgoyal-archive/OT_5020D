...
void SkDevice::drawText(const SkDraw& draw, const void* text, size_t len, const SkScalar* xOffset, const SkScalar* yOffset,
                            SkScalar x, SkScalar y, const SkPaint& paint) {
    draw.drawText((const char*)text, len, xOffset, yOffset, x, y, paint);
}
/** @} */

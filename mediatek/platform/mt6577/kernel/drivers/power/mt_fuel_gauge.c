...
extern int g_FG_init;		//mingquan.lai modify 20130125 for Camry
extern unsigned int UbVbat;		//mingquan.lai modify 20130125 for Camry
#endif
///////////////////////////////////////////////////////////////////////////////////////////
//// Define
///////////////////////////////////////////////////////////////////////////////////////////
...
#if defined(JRD_CAMRY_BORAD)
kal_int32 gFG_current_init = 0;		//mingquan.lai modify 20130125 for Camry
#endif
...
void fgauge_Normal_Mode_Work(void)
{
    int i=0;
#if defined(JRD_CAMRY_BORAD)
    kal_int32 fg_boot_current;		//mingquan.lai modify 20130125 for Camry
    kal_int32 UbVbat_tmp;			//mingquan.lai modify 20130125 for Camry
#endif
...
//mingquan.lai modify 20130125 for Camry
    if(gFG_booting_counter_I_FLAG == 1)
    {
        if(UbVbat & 0x80000000)  //USB connect from bootloader
         {         
...
#if defined(TELSA_FUEL_GAUGE)
            gFG_voltage = (UbVbat_tmp & 0x7FFF) - 50; 
#elif defined(DIABLOHD_FUEL_GAUGE)
            gFG_voltage = (UbVbat_tmp & 0x7FFF); 
#else 
            ...
            if(fg_boot_current == 0)  
             {
#if defined(TELSA_FUEL_GAUGE)
            gFG_voltage = (UbVbat_tmp & 0x7FFF) - 15; 
#elif defined(DIABLOHD_FUEL_GAUGE)
            gFG_voltage = (UbVbat_tmp & 0x7FFF) + 50; 
#else 
            gFG_voltage = (UbVbat_tmp & 0x7FFF); 
       ...
       else
        {
           UbVbat_tmp = UbVbat;
#if defined(TELSA_FUEL_GAUGE)
            gFG_voltage = (UbVbat_tmp & 0x7FFF) - 65; 
#elif defined(DIABLOHD_FUEL_GAUGE)
            gFG_voltage = (UbVbat_tmp & 0x7FFF); 
#else 
...
//4. update DOD0 after booting Xs
    if(gFG_booting_counter_I_FLAG == 1)
    {
        ...
        {
        #if defined(JRD_CAMRY_BORAD)
            //gForceADCsolution=1;            //mingquan.lai modify 20130125 for Camry
        #else
		gForceADCsolution=1; 
        #endif    

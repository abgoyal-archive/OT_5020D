...
#define GPIO_CAMERA_AF_EN_PIN		GPIO214
...
static int g_sr = 6;//modify by zhaiqingbo 2013.1.11 for DW9714A code
...
/* zhaiqingbo add for DW9714A write register 2013.1.11*/
static int s4FM50AF_WriteReg_2(u8 a_u2Data1,u8 a_u2Data2)
{
    int  i4RetValue = 0;

    char puSendCmd[2] = {(char)(a_u2Data1) , (char)(a_u2Data2)};

    //FM50AFDB("[FM50AF] g_sr %d, write %d-%d\n", g_sr, a_u2Data1,a_u2Data2);
    i4RetValue = i2c_master_send(g_pstFM50AF_I2Cclient, puSendCmd, 2);
    if (i4RetValue < 0)
    {
        FM50AFDB("[FM50AF] I2C send 2 failed!! \n");
        return -1;
    }
...
inline static int moveFM50AF(unsigned long a_u4Position)
{
    ...
    //FM50AFDB("[FM50AF] move [curr] %d [target] %d\n", g_u4CurrPosition, g_u4TargetPosition);
            ...
            spin_lock(&g_FM50AF_SpinLock);
            g_sr = 6;//modify by zhaiqingbo 2013.1.11 for DW9714A code
            g_i4MotorStatus = 0;
            spin_unlock(&g_FM50AF_SpinLock);	
...
static int FM50AF_Open(struct inode * a_pstInode, struct file * a_pstFile)
{
    ...
    g_s4FM50AF_Opened = 1;
    /* zhaiqingbo add for open DW9714A AF Linear Slope Control 2013.1.11*/
    s4FM50AF_WriteReg_2(0xEC,0xA3);
    s4FM50AF_WriteReg_2(0xA1, 0x05);
    s4FM50AF_WriteReg_2(0xF2, 0x08);
    s4FM50AF_WriteReg_2(0xDC, 0x51);
	/* zhaiqingbo add end */
    spin_unlock(&g_FM50AF_SpinLock);
...
{
    int i4RetValue = 0;
    /*zhaiqingbo-12.12.07,enable VCM driver to open AF, VCM IC is DW9714A, modify begin */
    ...
    /*zhaiqingbo-12.12.07,modify end */
...
static int FM50AF_remove(struct platform_device *pdev)
{
    ...
    /*zhaiqingbo-12.12.07,disable VCM driver to close AF, VCM IC is DW9714A, modify begin */
    mt_set_gpio_mode(GPIO_CAMERA_AF_EN_PIN, GPIO_MODE_GPIO);
    mt_set_gpio_dir(GPIO_CAMERA_AF_EN_PIN, GPIO_DIR_OUT);

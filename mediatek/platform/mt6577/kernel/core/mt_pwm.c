...
/* add by zhiping.liu for setting PWM3 driver current @start */
#define PWM_DRV_REG (0xF000180c)//(0xC000180C)
/* add by zhiping.liu for setting PWM3 driver current @end */
...
/* add by zhiping.liu for set PWM3 driver current to max @start */
	MASKREG32(PWM_DRV_REG,0x30000000,0x30000000);//set PWM3 current to 16mA
/* add by zhiping.liu for set PWM3 driver current to max @end */
